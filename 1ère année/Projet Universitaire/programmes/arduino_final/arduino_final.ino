...
void connect() {
  ...
  client.subscribe("/projet/sct013/tension");
  client.subscribe("/projet/si7021a/hum");
  client.subscribe("/projet/si7021a/ctemp");
  client.subscribe("/projet/si7021a/ftemp");
  client.subscribe("/projet/si7021a/crosee");
  client.subscribe("/projet/si7021a/frosee");
